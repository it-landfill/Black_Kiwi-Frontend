<template>
	<div class="relative z-[4]">
		...
		<div class="fixed z-[4] inset-0 overflow-y-auto">
			<div
				class="flex items-end sm:items-center justify-center min-h-full text-center sm:p-0"
			>
				<div
				...
				>
					<div class="px-4 pt-5 pb-5">
						<div>
							<img
								class="mx-auto w-[120px] h-auto"
								src="../../src/assets/images/black_kiwi.svg"
								alt="Workflow"
							/>
							<h2
								class="mt-6 text-center text-3xl font-extrabold text-slate-900"
							>
...
export default {
	...
	methods: {
		onSubmit() {
			...
			formdata.append("username", this.formData.mail);
